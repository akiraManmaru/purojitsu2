...
public class DistStationBlackBoxTest {
	...
	@Test
	public void クラスFarDistWarningはdist105のときに表示する() {
		float dist = 105f;
		String output = "";
	...
	@Test
	public void クラスFarDistWarningはdist104のときに表示しない() {
		float dist = 104f;
		String output = "";
	...
	@Test
	public void クラスNearDistWarningはdist95のときに表示する() {
		float dist = 95f;
		String output = "";
	...
	@Test
	public void クラスNearDistWarningはdist96のときに表示しない() {
		float dist = 96f;
		String output = "";
