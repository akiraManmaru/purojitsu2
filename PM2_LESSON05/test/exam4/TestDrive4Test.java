...
import lesson05.exam4.factory.CarGenerator;
import lesson05.exam4.factory.ElectricCarGenerator;
import lesson05.exam4.factory.VehicleGenerator;
import lesson05.exam4.factory.Type;

/**
 * TestDrive1の実行検査
 */
public class TestDrive4Test {
	...
	public void メソッド実装検査01() throws SecurityException, NoSuchMethodException {
		...
		+ "電気系を接続する\n"
		+ "シートと操作部をとりつける\n"
		+ "種別:軽自動車 名称:MBOX を製造しました。製造番号は 5 となります\n";
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(TestDrive4Test.class);
	}
}
