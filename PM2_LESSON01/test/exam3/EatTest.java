...
public class EatTest{
	...
	public void クラス実装検査() {
		try {
			Class.forName("headfirst.strategy.eat.Eat");
			assertTrue(true);
	...
	public void クラス依存関係検査() {
		Class<?>[] interfaces = headfirst.strategy.eat.Eat.class.getInterfaces();
	...
	public void メソッド実装検査() {
		...
		try {
			headfirst.strategy.eat.Eat.class.getDeclaredMethod("eat", parameterTypes1);
			assertTrue(true);
		...
		Method[] methods = headfirst.strategy.eat.Eat.class.getDeclaredMethods();
	...
	public void メソッド動作検査1() {
		...
		try {
			...
			headfirst.strategy.eat.Eat eatBehavior = new headfirst.strategy.eat.Eat();
			eatBehavior.eat();
