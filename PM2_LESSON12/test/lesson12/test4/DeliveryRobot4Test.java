...
public class DeliveryRobot4Test {
	...
	public void 配送ロボットクラスメソッド存在検査() {
		...
		methods.add("getPrimeDelivering");
		...
		for(Method m : DeliveryRobot4.class.getDeclaredMethods()) {
	...
	public void 配送ロボットクラスフィールド存在検査() {
		...
		for(Field f : DeliveryRobot4.class.getDeclaredFields()) {
