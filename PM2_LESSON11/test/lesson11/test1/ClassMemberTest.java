...
public class ClassMemberTest{
	...
	public void クラス実装検査01() {
		try {
			Class.forName("lesson11.exam1.ClassMember");
			assertTrue(true);
	...
	public void クラス依存関係検査01() {
		assertEquals("java.lang.Object", lesson11.exam1.ClassMember.class.getSuperclass().getName());
	}
	...
	public void フィールド実装検査01() {
		...
		for(Field f : lesson11.exam1.ClassMember.class.getDeclaredFields()) {
	...
	public void メソッド実装検査01() {
		...
		for(Method m : lesson11.exam1.ClassMember.class.getDeclaredMethods()) {
