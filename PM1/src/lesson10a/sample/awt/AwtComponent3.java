...
public class AwtComponent3 {
    ...
    public void createView() {
        ...
        panelRight.add(new Checkbox("通常", false, cbGroup));
        panelRight.add(new Checkbox("サイレン", false, cbGroup));
        panelRight.add(new Checkbox("速度二倍", true, cbGroup));
    ...
    public static void main(String[] args) {
        AwtComponent3 view = new AwtComponent3();
        view.createView();
    }
}
