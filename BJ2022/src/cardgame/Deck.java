...
public class Deck {
	 ...
	 *
	 */
	private static final int DECK_NUMBERS = Configuration.getConfiguration().getIntProperty("Deck.deckNumbers");
	...
	public void setupDeck() {
		...
		//		System.out.println("合計カード枚数：" + cardsNumber);
		//		System.out.println("Deckの数" + DECK_NUMBERS);
	}
